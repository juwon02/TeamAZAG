...
<div class="sidebar">
  ...
  <div class="sb-nav">
    ...
    <div class="sb-item" id="nav-todo" data-legacy-nav="todo">
      ...
      <span id="todoBadge" style="display:none;margin-left:auto" class="badge b-accent">새항목</span>
    </div>
...
</div><div class="modal-overlay" id="todoCreateModal">
    ...
    <div style="display:flex;gap:6px;margin-bottom:16px;align-items:center">
      ...
      <div style="flex:1;position:relative" id="calColorPicker">
        ...
        <div id="calColorDropdown" style="display:none;position:absolute;top:calc(100% + 4px);left:0;right:0;background:var(--surface);border:1px solid var(--border);border-radius:var(--radius-sm);z-index:100;overflow:hidden;box-shadow:0 4px 12px rgba(0,0,0,.08)">
          <div data-cal-color-value="ct-info" data-cal-color-label="일반" data-cal-color-css="var(--accent)" style="display:flex;align-items:center;gap:10px;padding:8px 12px;cursor:pointer;font-size:11px">
            <div style="width:8px;height:8px;border-radius:50%;background:var(--accent);flex-shrink:0"></div><span>일반</span>
          </div>
          <div data-cal-color-value="ct-warn" data-cal-color-label="주의" data-cal-color-css="var(--warn)" style="display:flex;align-items:center;gap:10px;padding:8px 12px;cursor:pointer;font-size:11px">
            <div style="width:8px;height:8px;border-radius:50%;background:var(--warn);flex-shrink:0"></div><span>주의</span>
          </div>
          <div data-cal-color-value="ct-danger" data-cal-color-label="위험" data-cal-color-css="var(--danger)" style="display:flex;align-items:center;gap:10px;padding:8px 12px;cursor:pointer;font-size:11px">
            <div style="width:8px;height:8px;border-radius:50%;background:var(--danger);flex-shrink:0"></div><span>위험</span>
          </div>
          <div data-cal-color-value="ct-success" data-cal-color-label="완료" data-cal-color-css="var(--success)" style="display:flex;align-items:center;gap:10px;padding:8px 12px;cursor:pointer;font-size:11px">
            <div style="width:8px;height:8px;border-radius:50%;background:var(--success);flex-shrink:0"></div><span>완료</span>
          </div>
        </div>
      </div>
    </div>
...
</div><div class="modal-overlay" id="confirmIssueModal">
