# delayed reply mail: Hyundai Mobis Tier2 납기 일정 반복 변경 긴급 주문

## 메타데이터
- doc_id: DOC-2026-010-MESSY-011
...
## 본문
다음 주 초 예상 Hyundai Mobis Tier2 / AP-WH-220 와이어하네스 건입니다. 고객 긴급 주문, 구매처 생산 일정 변경, 물류 출고 가능일이 서로 다르게 전달되어 확정 납기와 임시 납기가 섞인 상황
